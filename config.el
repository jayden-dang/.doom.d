...
(setq user-full-name "Dang Quang Vu"
      ...
      racer-rust-src-path '("~/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library"
                           "~/.rustup/toolchains/nightly-aarch64-apple-darwin/lib/rustlib/src/rust/library")
...
;; [[file:config.org::*Editor config][Editor config:1]]
...
;; [[file:config.org::*Disabled format save][Disabled format save:1]]
;; Disable linting
;; (setq +format-on-save-enabled-modes '(shell-mode bash-mode sh-mode))
;; Disabled format save:1 ends here

;; [[file:config.org::*exec-path][exec-path:1]]
(use-package! exec-path-from-shell
  :custom
